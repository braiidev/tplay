...
HELP_TABS: list[HelpTab] = [
    ...
    },
    {
        ...
        "lines": [
            ...
            ("    /         Nueva busqueda", PAIR_TEXTO),
            ("    Tab       Cambiar motor/prompt", PAIR_TEXTO),
            ("    j/k       Navegar resultados", PAIR_TEXTO),
            ("    g/G       Inicio / Fin", PAIR_TEXTO),
            ("    Enter     Reproducir resultado", PAIR_TEXTO),
            ("    D         Descarga directa", PAIR_TEXTO),
            ("    d         Descarga con config", PAIR_TEXTO),
            ...
            ("    Tab       Cambiar a motor", PAIR_TEXTO),
            ("    Esc       Cancelar busqueda", PAIR_TEXTO),
            ("    Backsp    Borrar caracter", PAIR_TEXTO),
            ("", None),
            ("  MOTOR", PAIR_NAV),
            ("", None),
            ("    j/k       Navegar plataformas", PAIR_TEXTO),
            ("    a         Agregar plataforma", PAIR_TEXTO),
            ("    e         Editar plataforma", PAIR_TEXTO),
