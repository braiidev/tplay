...
HELP_TABS = [
    ...
    },
    {
        ...
        "lines": [
            ...
            ("  MODO", 3),
            ("", None),
            ("    r / R     Aleatorio / Repetir global", 2),
            ("", None),
            ("  TIEMPO", 3),
            ("", None),
            ("    g         Ir a tiempo", 2),
            ("    t / T     Temporizador activar / configurar", 2),
            ("", None),
            ("  PILA / URL", 3),
            ("", None),
            ...
            ("  PILA (vista)", 3),
            ("", None),
            ("    Enter     Mover reproducción al elemento", 2),
