...
HELP_TABS: list[HelpTab] = [
    ...
    },
    {
        ...
        "lines": [
            ...
            ("  MODO", 3),
            ("", None),
            ("    r         Aleatorio ON/OFF", 2),
            ("    R         Repetir ON/OFF", 2),
            ("", None),
            ("  TIEMPO", 3),
            ("", None),
            ("    g         Ir a tiempo", 2),
            ("    t         Activar temporizador", 2),
            ("    T         Configurar temporizador", 2),
            ("", None),
            ("  PILA / URL", 3),
            ("", None),
            ("    Tab       Ver pila de reproducción", 2),
    ...
    },
    {
        ...
        "lines": [
            ...
            ("    u / U     Deshacer / Rehacer", 2),
            ("", None),
            ("  COPIAR / MOVER", 3),
            ("", None),
            ("    Enter/C/V  Pegar en directorio", 2),
            ("    u          Deshacer última op", 2),
            ("    Esc        Cancelar", 2),
            ("", None),
            ("  METADATOS", 3),
            ("", None),
    ...
    },
    {
        ...
        "lines": [
            ...
            ("", None),
            ("    c         Crear nueva lista", 2),
            ("    D         Eliminar lista", 2),
            ("    R         Renombrar lista", 2),
            ("    [ / ]     Lista ant / sig", 2),
            ("    s         Guardar lista", 2),
            ("    X         Exportar como M3U", 2),
            ("", None),
            ("  ELEMENTOS", 3),
            ("", None),
            ("    Enter     Reproducir elemento", 2),
    ...
    },
    {
        ...
        "lines": [
            ...
            ("", None),
            ("    j / k     Cursor abajo / arriba", 2),
            ("    h / [     Pestaña anterior", 2),
            ("    l / ]     Pestaña siguiente", 2),
            ("    → / Enter Activar / cambiar valor", 2),
            ("    ←         Cambiar valor", 2),
            ("", None),
            ("  TECLAS", 3),
            ("", None),
            ...
            ("", None),
            ("    j / k     Cursor abajo / arriba", 2),
            ("    h / ←     Directorio padre", 2),
            ("    l / →     Entrar directorio", 2),
            ("    Enter     Seleccionar directorio", 2),
            ("    ~         Ir a home", 2),
            ("    g / G     Inicio / Fin", 2),
            ("    Esc       Cancelar", 2),
        ]
