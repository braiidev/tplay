...
- **Bugs abiertos**: 0
- **Tests**: 12 nuevos (ytdlp_update), todos pasan
- **Docs**: Sincronizados con v1.8.0

## Último commit
- `v1.7.2 docs — changelog, devlog, state, todo` (v1.8.0 sin commitear aún)

## Resumen v1.5.75→v1.8.0
| Versión | Cambio |
|---------|--------|
